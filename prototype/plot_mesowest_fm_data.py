#
#
#  This script plots the spatial structure of the fuel moisture field from the fuel
#  moisture stations.
#
...
if __name__ == '__main__':
    ...
    init_diagnostics('results/plot_mesowest_station_data.log')
...
#    plt.plot(x, y, 'k+', markersize = 4)
    ...
    print('Length of observation time series from st %d, from model %d, common %d' % (len(tms), len(tm), len(mtm)))
